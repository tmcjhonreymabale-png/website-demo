...
(1, NULL, 'Our History', 'Our barangay was established in 1950 with a vision to serve the community. Over the years, we have grown and developed into a progressive community that values unity, cooperation, and development.', 'history', 1, 0, '2026-03-28 04:24:28', '2026-03-28 16:34:06'),
...
(4, 'mainadmin', '$2y$10$cOLGvSZOvr/LnaydBagWHObkSdpg1Q6KvBfGqzJGIub4QfmQHSOTS', 'main_admin', 'mainadmin@barangay.com', 'Main', 'Admin', NULL, '2026-03-28 17:31:14', 1, '2026-03-13 05:14:04'),
...
(178, 4, 'LOGIN', 'Admin logged in', '::1', NULL, '2026-03-28 08:35:34'),
(179, 4, 'DELETE_REQUEST', 'Deleted request #3', '::1', NULL, '2026-03-28 13:47:56'),
(180, 4, 'DELETE_REQUEST', 'Deleted request #4', '::1', NULL, '2026-03-28 13:48:14'),
(181, 4, 'EXPORT_REQUESTS', 'Exported 2 request(s) to CSV', '::1', NULL, '2026-03-28 13:55:57'),
(182, 4, 'EXPORT_REQUESTS', 'Exported 2 request(s) to CSV', '::1', NULL, '2026-03-28 13:55:57'),
(183, 4, 'EXPORT_REQUESTS', 'Exported 2 request(s) to CSV', '::1', NULL, '2026-03-28 13:56:00'),
(184, 4, 'EXPORT_REQUESTS', 'Exported 2 request(s) to CSV', '::1', NULL, '2026-03-28 14:08:47'),
(185, 4, 'EXPORT_REQUESTS', 'Exported 2 request(s) to CSV', '::1', NULL, '2026-03-28 14:08:48'),
(186, 4, 'EXPORT_REQUESTS', 'Exported 2 request(s) to CSV', '::1', NULL, '2026-03-28 14:08:51'),
(187, 4, 'EXPORT_REQUESTS', 'Exported 2 request(s) to CSV', '::1', NULL, '2026-03-28 14:21:22'),
(188, 4, 'EXPORT_REQUESTS', 'Exported 2 request(s) to CSV', '::1', NULL, '2026-03-28 14:52:35'),
(189, 4, 'LOGOUT', 'Admin logged out', '::1', NULL, '2026-03-28 15:06:04'),
(190, 4, 'LOGIN', 'Admin logged in', '::1', NULL, '2026-03-28 15:06:07'),
(191, 4, 'DELETE_REQUEST', 'Deleted request #5', '::1', NULL, '2026-03-28 15:11:02'),
(192, 4, 'DELETE_REPORT', 'Deleted report #2', '::1', NULL, '2026-03-28 15:26:16'),
(193, 4, 'EXPORT_REQUESTS', 'Exported 1 request(s) to CSV', '::1', NULL, '2026-03-28 15:26:54'),
(194, 4, 'EXPORT_REQUESTS', 'Exported 1 request(s) to CSV', '::1', NULL, '2026-03-28 15:26:54'),
(195, 4, 'EXPORT_REQUESTS', 'Exported 1 request(s) to CSV', '::1', NULL, '2026-03-28 15:26:55'),
(196, 4, 'EXPORT_REQUESTS', 'Exported 1 request(s) to CSV', '::1', NULL, '2026-03-28 15:26:57'),
(197, 4, 'GENERATE_QR', 'Generated QR code for resident: John Rey Mabale', '::1', NULL, '2026-03-28 15:35:58'),
(198, 4, 'GENERATE_QR', 'Generated QR code for resident: John Rey Mabale', '::1', NULL, '2026-03-28 16:32:02'),
(199, 4, 'GENERATE_QR', 'Generated QR code for resident: John Rey Mabale', '::1', NULL, '2026-03-28 16:32:09'),
(200, 4, 'UPDATE_ABOUT_SECTION', 'Updated about section ID: 1 - Our History', '::1', NULL, '2026-03-28 16:34:06'),
(201, 4, 'LOGOUT', 'Admin logged out', '::1', NULL, '2026-03-28 17:00:27'),
(202, 4, 'LOGIN', 'Admin logged in', '::1', NULL, '2026-03-28 17:00:30'),
(203, 4, 'LOGIN', 'Admin logged in', '::1', NULL, '2026-03-28 17:00:54'),
(204, 4, 'LOGIN', 'Admin logged in', '::1', NULL, '2026-03-28 17:31:14');
...
(1, 1, 'BARANGAY-RESIDENT-000001-20260328-69c802820d546', NULL, '2026-03-28 16:32:02', '2027-03-28', 1),
(2, 2, 'BARANGAY-RESIDENT-000002-20260328-69c802893947b', NULL, '2026-03-28 16:32:09', '2027-03-28', 1);
...
INSERT INTO `resident_reports` (`id`, `user_id`, `report_type`, `subject`, `description`, `location`, `attachment`, `priority`, `status`, `admin_remarks`, `reported_date`, `resolved_date`, `resolved_by`) VALUES
(1, 1, 'concern', 'dfndfh', 'dhdh', 'rhr', NULL, 'high', 'pending', NULL, '2026-03-28 08:09:51', NULL, NULL);
...
INSERT INTO `resident_requests` (`id`, `user_id`, `service_id`, `request_type`, `preferred_day`, `preferred_time`, `schedule_id`, `preferred_date`, `status`, `admin_remarks`, `qr_token`, `request_date`, `processed_date`, `processed_by`) VALUES
(6, 1, 1, 'online', 'Saturday', '', NULL, '2026-03-30', 'pending', NULL, 'REQ-000006-75ab9c77', '2026-03-28 10:20:26', NULL, NULL);
...
INSERT INTO `services` (`id`, `service_name`, `description`, `requirements`, `fee`, `is_active`, `created_at`) VALUES
(1, 'Barangay Clearance', 'Official document certifying a person\'s residency and good moral character', '', 50.00, 1, '2026-03-13 04:28:56'),
(2, 'Certificate of Indigency', 'Certificate for residents belonging to low-income families', NULL, 30.00, 1, '2026-03-13 04:28:56'),
(3, 'Business Clearance', 'Clearance for business permit application', NULL, 100.00, 1, '2026-03-13 04:28:56'),
(4, 'Residency Certificate', 'Proof of residency in the barangay', NULL, 50.00, 1, '2026-03-13 04:28:56'),
(5, 'hi', 'hello', '123', 50.00, 0, '2026-03-14 09:14:37');
...
(1, 'john rey', 'johnreyfernandez41@gmail.com', 'user_1_1774678631.jpg', '$2y$10$jKr21pNJn/n/aJH9IGNwFOD5oAqAOTS7Hb8z9wsAQll6vP.QAFGcS', 'John Rey', 'Mabale', 'blk 6 b lot 3 phase 3, brgy, aguado trece martires', '09625151044', 'resident', 0, '2026-03-28 17:32:39', '2026-03-13 04:42:03', 0, 'active', '2026-03-29 01:32:39', NULL),
(2, 'Johnreymabale', 'mabalejohnreyf@gmail.com', NULL, '$2y$10$jM/8TfMz.6mx/K8cOgJS2e2u6/al1Rqr1fzjGu9HxQ5auHDFdjCq.', 'John Rey', 'Mabale', 'blk 6 b lot 3 phase 3, brgy, aguado trece martires', '09625151044', 'resident', 0, '2026-03-28 17:26:44', '2026-03-26 01:51:09', 0, 'active', '2026-03-29 01:26:18', '::1');
...
--
ALTER TABLE `resident_feedback`
  ADD CONSTRAINT `resident_feedback_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
